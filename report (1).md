...
Для покращення якості коду рекомендовано:
- Використовувати PreparedStatement
- Винести конфігурацію в environment variables
- Розділити шари (Controller / Service / Repository)
- Додати валідацію вхідних даних
- Реалізувати коректну обробку винятків
- Використовувати try-with-resources

Після виправлення зазначених проблем код стане безпечнішим, читабельнішим та придатним до масштабування і підтримки.
